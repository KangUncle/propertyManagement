...
import com.snk.common.utils.file.OSSFileUploadUtils;
...
//            return ajax;
            ...
            //文件上传
            OSSFileUploadUtils.uploadFile(fileName, file);
            //构建返回参数
            String url="https://xiankanglg10.oss-cn-beijing.aliyuncs.com/"+fileName;
            AjaxResult ajax = AjaxResult.success();
            ajax.put("fileName", fileName);
            ajax.put("url", url);
            return ajax;
